...
// optional-peer-dep:__vite-optional-peer-dep:react-redux:@reduxjs/toolkit
throw new Error(`Could not resolve "react-redux" imported by "@reduxjs/toolkit". Is it installed?`);
...
function useShallowStableValue(value) {
  ...
  (0, import_react3.useEffect)(() => {
    if (!(void 0)(cache22.current, value)) {
      cache22.current = value;
    }
  }, [value]);
  return (void 0)(cache22.current, value) ? cache22.current : value;
}
...
function buildHooks({
  ...
  function buildQueryHooks(name) {
    ...
    const useQueryState = (arg, {
      ...
      const currentState = useSelector((state) => querySelector(state, lastValue.current), void 0);
  ...
  function buildMutationHook(name) {
    return ({
      ...
      const currentState = useSelector(mutationSelector, void 0);
...
function ApiProvider(props) {
  const context = props.context || void 0;
  ...
  return import_react6.default.createElement(void 0, { store, context }, props.children);
}
